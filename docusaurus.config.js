...
const config = {
  title: 'Cron To Go Documentation',
  titleDelimiter: ':',
  tagline: 'Explore our guides and examples to integrate Cron To Go.',
  url,
  baseUrl,
  onBrokenLinks: 'throw',
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: 'https://github.com/crazyantlabs/crontogo-docs/tree/main/',
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/crazyantlabs/crontogo-docs',
            position: 'right',
